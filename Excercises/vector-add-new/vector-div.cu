...
void vectorAddCuda(int n, float* a, float* b, float* result) {
    ...
    cout << "vector-div (kernel): \t\t" << kernelTime1  << endl;
    cout << "vector-div (memory): \t\t" << memoryTime << endl;
}
...
int vectorAddSeq(int n, float* a, float* b, float* result) {
  ...
  cout << "vector-div (sequential): \t\t" << sequentialTime << endl;
...
int main(int argc, char* argv[]) {
    ...
    cout << "Dividing two vectors of " << n << " integer elements." << endl;
